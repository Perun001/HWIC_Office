...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "HWIC_officer":
			...
			{
				dialog.text = "Aha! I think I know who you are... But of course! You are wanted for your crimes! Lads, seize him!";
				link.l1 = "Damn!";
				link.l1.go = "fight";
				break;
			}
		...
		case "HWIC_officer_3":
			dialog.text = "Talk to mynheer Gerritz. His table is on your left. He does business with captains.";
		...
		case "HWIC_headclerk":
			...
			if (ChangeCharacterHunterScore(Pchar, "holhunter", 0) > 12)
			{
				dialog.text = "Hm. I think that there is something wrong about you... But of course! You are wanted for your numerous crimes against Holland! Soldiers, take him!";
				link.l1 = "Damn!";
				link.l1.go = "fight";
				break;
			}
			...
			{
				link.l3 = "I have an interesting document for you, mynheer. Read its beginning. It concerns the security of Holland. I will give them to you in case you are interested. The coordinates of the meeting are in there as well. Not for free of course.";
				link.l3.go = "depeshe";	
			}
			// калеуче
		...
		case "licence":
			...
			{
				dialog.text = "Well, you are welcome to buy it. So, how many days?";
				link.l1.edit = 6;
				link.l1 = "";	
		...
		case "licence_0":
			dialog.text = "The license grants a free passage to any port of any nation, it shows your peaceful intentions and explains your purpose - to trade. But it won't help you if you have any problems with the law. They will simply take it from you in that case. Remember, \nDon't forget to raise a friendly flag before you sail into any port, patrols and forts' cannoneers prefer to shoot first and ask later\Right, almost forgot, according to our traditions, all deals involving licenses are paid in doubloons... and that would be it. Now let us discuss the terms. For how long are you willing to use the license?";
			link.l1.edit = 6;
			link.l1 = "";	
			link.l1.go = "licence_1";
		...
		case "trade_silk_1":
			...
			dialog.text = "Pleasure doing business with you, captain. Your silk will be delivered to your ship on a boat.";
			link.l1 = "Thanks!";
